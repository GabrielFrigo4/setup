...
9. **Desconstrução da Rusticidade & Modularização:** Scripts monolíticos devem ser desmembrados em receitas atômicas, modulares e idempotentes, garantindo estrita conformidade POSIX `/bin/sh` sem bashismos residuais.
